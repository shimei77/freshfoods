		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="web/shop.php">購買</a>
              	<a class="dropdown-item" href="web/wishlist.php">願望清單</a>
                <a class="dropdown-item" href="web/product-single.php">詳細介紹</a>
                <a class="dropdown-item" href="web/cart.php">購物車</a>
                <a class="dropdown-item" href="web/checkout.php">結帳</a>
              </div>
            </li> -->
					<li class="nav-item"><a href="web/about.php" class="nav-link">關於我們</a></li>
					<!-- <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li> -->
					<li class="nav-item"><a href="web/contact.php" class="nav-link">連絡我們</a></li>
					<li class="nav-item cta cta-colored"><a href="web/cart.php" class="nav-link"><span class="icon-shopping_cart"></span>[<?php if (isset($_SESSION['Cart']) && $_SESSION['Cart'] != null) echo count($_SESSION['Cart']);
																																			else echo "0"; ?>]</a></li>
				...
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
						...
						<div class="col-md-12 ftco-animate text-center">
							<h1 class="mb-2 ctfont">我們提供新鮮蔬果</h1>
				...
				<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services mb-md-0 mb-4">
						...
						<div class="media-body">
							<h3 class="heading">免費運送</h3>
							<span>訂單超過$NT100</span>
						</div>
					</div>
				</div>
				<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
			...
			<div class="row">
						...
						<div class="col-md-6 order-md-last align-items-stretch d-flex">
							<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
								<div class="text text-center">
									<h2>Vegetables</h2>
									<p>家庭健康由我守護</p>
									<p><a href="web/shop.php?categoryID=0" class="btn btn-primary">購物去</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpg);">
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="web/shop.php?categoryID=1">蔬菜</a></h2>
								</div>
							</div>
							<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-2.jpg);">
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="web/shop.php?categoryID=2">水果</a></h2>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-3.jpg);">
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="web/shop.php?categoryID=3">果汁</a></h2>
						</div>
					</div>
					<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-4.jpg);">
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="web/shop.php?categoryID=4">堅果</a></h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center mb-3 pb-3">
				<div class="col-md-12 heading-section text-center ftco-animate">
					<span class="subheading">精選產品</span>
					<h2 class="mb-4">Our Products</h2>
					<p>超值、新鮮。關愛您的家人，健康每一天 &hearts;</p>
				</div>
			</div>
		</div>
		<div class="container">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#" class="py-2 d-block">連絡我們 Us</a></li>
						</ul>
					</div>
				</div>
