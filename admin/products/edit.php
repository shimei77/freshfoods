...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "EDIT"){
  $sql= "UPDATE products SET price=:price, name=:name, description=:description, updated_at=:updated_at, productID=:productID, product_categoryID=:product_categoryID where productID=:productID";
  $sth = $db ->prepare($sql);
